...
namespace LeeTeke.HttpServerLite
{
    ...
    public static class HttpContextType
    {
        ...
        /// 默认Html类型
        /// </summary>
        public const string Default_Html = "text/html";
        /// <summary>
        /// 默认 Json类型
        /// </summary>
        public const string Default_Json = "application/json";
        /// <summary>
        /// 默认Txt
        /// </summary>
        public const string Default_Txt = "text/plain";
        ...
        /// <returns></returns>
        public static string Encoder(string type, string encoding)
        {
